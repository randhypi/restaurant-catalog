...
class FoodItem extends HTMLElement {
  ...
  render() {
    this.innerHTML = `     
    <img src="${this._food.pictureId ? CONFIG.BASE_IMAGE_URL + this._food.pictureId : 'https://picsum.photos/id/666/800/450?grayscale'}" alt="Image food ${this._food.name}
    ...
    <h3 class="post_item_kota">  Kota ${this._food.city} </h3>
      ...
      <h2 class="post_item_rating">Rating : ${this._food.rating}</h2>
              ...
              <a href="/#/detail/${this._food.id}"> selengkapnya...</a> </p>
      </div>
          `;
  }
}
